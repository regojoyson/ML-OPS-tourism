...
Xtest_path = "hf://datasets/samuelrego/mlops_dataset/Xtest.csv"
ytrain_path = "hf://datasets/samuelrego/mlops_dataset/ytrain.csv"
ytest_path = "hf://datasets/samuelrego/mlops_dataset/ytest.csv"
...
numeric_features = [
    ...
    'PitchSatisfactionScore', 'MonthlyIncome', 'NumberOfChildrenVisiting'
]

categorical_features = [
    'TypeofContact', 'CityTier', 'Occupation', 'Gender',
    'MaritalStatus', 'ProductPitched', 'Passport', 'OwnCar', 'Designation'
]

# Handle class imbalance
class_weight = ytrain.value_counts().values[0] / ytrain.value_counts().values[1]
...
# Step 4: Train, tune, log, evaluate, and register
with mlflow.start_run():
    ...
    # Step 5: Register the best model in Hugging Face model hub
    repo_id = "samuelrego/tourism_package_model"
    repo_type = "model"
